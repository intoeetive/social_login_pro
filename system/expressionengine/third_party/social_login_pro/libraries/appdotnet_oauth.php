...
*/
    ...
    function start_following($username='', $response = array())
    {
		...
		$baseurl = self::SCHEME.'://alpha-api.app.net/stream/0/users/'.$username."/follow?access_token=".$response['access_token'];
    ...
    function post($message, $url, $oauth_token='', $oauth_token_secret='')
    {
        ...
        $baseurl = self::SCHEME.'://alpha-api.app.net/stream/0/posts?access_token='.$oauth_token;
        $fields = array(
