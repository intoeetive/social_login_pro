...
class facebook_oauth
{
    ...
    public function get_request_token($callback, $will_post=true, $session_id=false, $is_popup=false)
    {
        ...
        $redirect = self::SCHEME.'://'.self::HOST.self::AUTHORIZE_URI."?type=web_server&scope=$scope&display=$display&client_id=".$this->_consumer['key']."&redirect_uri=".urlencode($callback);
